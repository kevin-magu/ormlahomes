    ...
    <form id="editForm"  >
        ...
        <option value="Rental" <?= $property['listing_type'] === 'Rental' ? 'selected' : '' ?>>Rental</option>
            ...
            <select name="subcategory" required>
                ...
                $allSubs = ['Apartment','Condo','Duplex','Vacation Home','Townhous','Office space','Retail units','Mall','Restaurants and Hotel','Mixed use','Warehouse','Factorie','Manufacturing plant','Distribution center','Storage facility','Vacant lot','Agricultural_land','Development land'];
